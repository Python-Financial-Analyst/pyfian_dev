...
if __name__ == "__main__":
    ...
    for offset, cpn in list_maturities_rates:
        bond = FixedRateBullet(
            ...
            cpn_freq=2 if date + offset >= one_year_offset else 0,  # Less than a year
            cpn=cpn if date + offset >= one_year_offset else 0,
            bond_price=100 if date + offset >= one_year_offset else None,
            yield_to_maturity=None if date + offset >= one_year_offset else cpn / 100,
